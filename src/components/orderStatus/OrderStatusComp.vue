...
const steps = ref([
    ...
    {
        title: 'Entregue',
        icon: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 11L12 2L21 11V22H3V11Z"/><polyline points="9 22 9 14 15 14 15 22"/></svg>`,
        completed: false
    }
]);
